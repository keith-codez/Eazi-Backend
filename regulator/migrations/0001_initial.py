    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('agent', 'Agent'), ('agency', 'Agency')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agents', models.ManyToManyField(blank=True, help_text='Agents linked to this customer', related_name='customers', to='regulator.agent')),
                ('related_agency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customers', to='regulator.agency')),
